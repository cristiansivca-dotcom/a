...
export default function DebitNotePage() {
    ...
    console.log(isFetchingRate); // To avoid unused warning if not using in UI yet, or just remove
    ...
    useEffect(() => {
            ...
            try {
                ...
                if (invItems && invItems.length > 0) {
                    setItems(invItems.map(item => ({
                        ...
                        price: 0, // Set to 0 so user can input the adjustment
                        total: 0
                    })));
                }
        ...
        if (id) fetchData();
    }, [id, router, toastError, supabase, fetchLastNoteNumber]);
